...
const fetchActivityLike = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/member/${memberId.value}/like`)
...
const fetchActivityReview = async () => {
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/member/${memberId.value}/review`
    )
...
const fetchActivityRegistration = async () => {
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/member/${memberId.value}/registration`
    )
...
const deleteLike = async (likeId) => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/like/${likeId}/delete`, {
      method: 'DELETE',
...
const deleteRegistration = async (registrationId) => {
  ...
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/registration/${registrationId}/delete`,
      {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' },
      }
