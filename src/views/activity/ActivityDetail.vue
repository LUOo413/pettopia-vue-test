...
const fetchActivityData = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}`)
...
const fetchActivityImageList = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/image`)
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
...
const fetchReviewList = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/review`)
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
...
const fetchActivityList = async () => {
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/all/except/${props.activityId}`
    )
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
...
const increaseNumberOfVisitor = async () => {
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/increase/number/visitor`
    )
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
    const data = await response.json()
...
const getActivityPeople = async () => {
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/registration/people/number`
    )
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
    const data = await response.json()
...
const getReviewIsExisied = async () => {
  const response = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/member/${memberId}/review/exist`,
    {
      method: 'GET',
...
const isActivityAvalible = async () => {
  ...
  const response1 = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/registration/status`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
  ...
  const response2 = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/member/${memberId}/regist/status`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
...
const registActivity = async () => {
  ...
  const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/regist`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
const openRegistrationConditon = async () => {
  ...
  const response1 = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/registration/pending`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
  ...
  const response2 = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/registration/confirmed`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
...
const getLikeStatus = async () => {
  const response = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/member/${memberId}/like/status`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
...
const toggleLike = async () => {
  ...
  const response = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/like/toggle`,
    {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(data),
...
const submitComment = async () => {
  ...
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/review/add`,
      {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
const openRewirte = async (reviewId) => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/review/${reviewId}`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    })
    let result = await response.json()
...
const submitRewrite = async (reviewId) => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/review/${reviewId}/rewrite`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(commentForm.value),
    })
...
const deleteComment = async (reviewId) => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/review/${reviewId}/delete`, {
      method: 'DELETE',
      headers: { 'Content-Type': 'application/json' },
    })
    let result = await response.json()
...
const openMember = async () => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/${props.activityId}/like`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    })
...
const fetchSameTypeActivitiesExceptOne = async (typeId) => {
  const response = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/activity/type/${typeId}/except/activity/${props.activityId}`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
