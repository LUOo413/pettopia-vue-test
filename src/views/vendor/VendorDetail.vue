...
const fetchVendorData = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}`)
...
const fetchVendorImageList = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/image`)
...
const fetchVendorReviewList = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/review`)
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
...
const fetchVendorList = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/all/except/${props.vendorId}`)
    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`)
    const data = await response.json()
...
const getReviewIsExisied = async () => {
  const response = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/member/${memberId}/review/exist`,
    {
      method: 'GET',
...
const getTag = async () => {
  const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/tag`, {
    method: 'GET',
    headers: { 'Content-Type': 'application/json' },
  })
  let result = await response.json()
...
const getActivities = async () => {
  const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/activity/vendor/${props.vendorId}`, {
    method: 'GET',
    headers: { 'Content-Type': 'application/json' },
  })
...
const getLikeStatus = async () => {
  const response = await fetch(
    `https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/member/${memberId}/like/status`,
    {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    }
...
const toggleLike = async () => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/like/toggle`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
const submitReviewFinal = async () => {
  ...
  try {
    await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/review/add/final`, {
      method: 'POST',
      body: formData,
    })
...
const openMember = async () => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/like`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    })
...
const openCategory = async (categoryId) => {
  ...
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/vendor/category/${categoryId}/except/vendor/${props.vendorId}`,
      {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
      }
...
const fetchAvgRate = async () => {
  try {
    const response = await fetch(
      `https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/update/rating`,
      {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
      }
...
const fetchCoordinate = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/${props.vendorId}/coordinate`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    })
    let result = await response.json()
