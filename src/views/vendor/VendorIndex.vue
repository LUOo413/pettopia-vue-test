...
const fetchVendorList = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/all`)
...
const fetchVendorCategory = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/category/show`)
...
const fetchCoordinate = async () => {
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/all/coordinate`, {
      method: 'GET',
...
const findCoordinateByKeyword = async () => {
  ...
  try {
    const response = await fetch(`https://vmtest-1-w8r3.onrender.com/api/vendor/coordinate/find`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
