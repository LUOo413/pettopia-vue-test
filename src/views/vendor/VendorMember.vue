...
const fetchActivityLike = async () => {
  try {
    const response = await fetch(`https://pettopia-1743656430689.azurewebsites.net/api/vendor/member/${memberId.value}/like`)
...
const fetchActivityReview = async () => {
  try {
    const response = await fetch(`https://pettopia-1743656430689.azurewebsites.net/api/vendor/member/${memberId.value}/review`)
...
const deleteLike = async (likeId) => {
  ...
  try {
    const response = await fetch(`https://pettopia-1743656430689.azurewebsites.net/api/vendor/like/${likeId}/delete`, {
      method: 'DELETE',
