...
async function fetchActivityDetail() {
    ...
    try {
        const response = await axios.get(`https://vmtest-1-w8r3.onrender.com/api/vendor_admin/vendor_admin_activityDetail?id=${activityId}`);
...
const loadImages = () => {
    vendorActivityImageIdList.value.forEach((imageId, index) => {
        axios.get(`https://vmtest-1-w8r3.onrender.com/photos/download?photoId=${imageId}`, {
            headers: {
...
const submitForm = async () => {
    ...
    axios({
        method: 'post',
        url: 'https://vmtest-1-w8r3.onrender.com/api/vendor_activity/update',
        data: formData,
        headers: {
