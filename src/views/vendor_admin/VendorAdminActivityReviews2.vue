...
const loadActivities = async () => {
    try {
        const response = await axios.get(`https://vmtest-1-w8r3.onrender.com/api/vendor_admin/activity/${vendorId}`, { headers: { 'Accept': 'application/json' } });
...
//     try {
//         const response = await axios.get(`https://vmtest-1-w8r3.onrender.com/api/vendor_admin/activityreviews?vendorActivityId=${activityId}`, { headers: { 'Accept': 'application/json' } });
