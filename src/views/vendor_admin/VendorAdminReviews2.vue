            ...
            <div class="card-body">
              ...
              <div class="photo-container">
                <img v-for="photoId in reviewPhotos" :key="photoId"
                  :src="`https://vmtest-1-w8r3.onrender.com/review_photos/download?photoId=${photoId}`"
...
const fetchReviews = async () => {
  try {
    const response = await axios.get('https://vmtest-1-w8r3.onrender.com/api/vendor_admin/review?vendorId=1', {
...
const showPhotoModal = (photoId) => {
  selectedPhoto.value = `https://vmtest-1-w8r3.onrender.com/review_photos/download?photoId=${photoId}`
