...
const submitForm = async () => {
  ...
  axios
    .post('https://pettopia-1743656430689.azurewebsites.net/api/vendor_activity/add', formdata)
    .then((response) => {
      alert('新增成功')
...
onMounted(() => {
  axios
    .get('https://pettopia-1743656430689.azurewebsites.net/api/vendor_admin/activity/allTypes') // 確保端點正確
    .then((response) => {
