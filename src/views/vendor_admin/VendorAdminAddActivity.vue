                    ...
                    <form @submit.prevent="submitForm" id="activity_form">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label>活動名稱:</label>
                                <input type="text" name="activity_name" id="activity_name" v-model="activityName"
                                    required="required" />
                            </div>
                            <div class="form-group">
                                <label>活動類型:</label>
                                <select name="activity_type_id" class="form-control" id="activity_type_id"
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <textarea name="activity_description" id="activity_description"
                                    v-model="activityDescription" required="required"></textarea>
                            </div>
                            <div class="form-group">
                                <label>活動地址:</label>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="is_registration_required" class="form-control"
                                    id="is_registration_required" @change="toggleMaxParticipants"
                                    v-model="isRegistrationRequired" required="required">
                                    <option v-for="option in registrationOptions" :key="option.value"
...
const submitForm = () => {
    ...
    axios.post('http://localhost:8080/api/vendor_activity/add', formdata)
        .then(response => {
            alert('新增成功');
